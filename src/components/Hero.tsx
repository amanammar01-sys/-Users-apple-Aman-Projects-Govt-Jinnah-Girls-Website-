  ...
  return (
    <section className="relative w-full max-w-[100vw] overflow-hidden pb-0">
      ...
      >
        ...
        {/* Dark scrim so text stays readable on the banner at every size */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-navy-950/95 via-navy-900/80 to-navy-900/25 sm:via-navy-900/70 lg:w-[62%] lg:from-navy-950/85 lg:via-navy-900/65 lg:to-transparent" />

        {/* Text on the banner — all screen sizes */}
        <div className="absolute inset-0 z-10 flex items-center justify-start px-4 py-10 sm:px-6 sm:py-12 lg:px-0">
          <div className="w-full max-w-xl text-left lg:max-w-[560px] lg:pl-10 lg:pr-6 xl:pl-16">
            ...
            <motion.h1
              ...
              className="text-left text-2xl font-bold leading-tight tracking-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)] sm:text-4xl md:text-5xl lg:text-[2.75rem] lg:leading-[1.2]"
            >
            ...
            <motion.p
              ...
              className="mt-3 text-left text-sm font-medium leading-relaxed text-white/95 drop-shadow-[0_1px_4px_rgba(0,0,0,0.45)] sm:mt-4 sm:text-lg md:text-xl"
            >
            ...
            <motion.div
              ...
              className="mt-6 flex flex-wrap justify-start gap-3 sm:mt-8"
            >
              <Link
                href="/contact"
