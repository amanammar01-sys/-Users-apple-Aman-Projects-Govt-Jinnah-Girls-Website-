  ...
  return (
    <section className="relative overflow-hidden bg-navy-900 py-16 text-white sm:py-20">
      ...
      <div className="container-wide relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="whitespace-nowrap text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
          {title}
        </h1>
        {subtitle && (
          <p className="mt-4 max-w-2xl text-base text-gray-300 sm:text-lg">{subtitle}</p>
        )}
      </div>
    </section>
  );
